      ...
      <div className="p-5 bg-[#F5F7FB]">
        ...
        <div className="flex justify-center">
          <input
            ...
            className="rounded-sm border border-[#2D64CF] w-full h-10 px-2 focus:outline-none"
          ></input>
        </div>
        <div className="flex justify-center mt-4">
          <button className="text-white bg-gradient-to-r from-blue-700 to-sky-400 rounded-sm border w-full h-12 font-bold">
            รับข่าวสาร
          </button>
        </div>
      </div>
