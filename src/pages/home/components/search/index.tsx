  ...
  function handleClick() {
    ...
    return <div className=" shadow-md h-32 mx-60 rounded-md ">
      ...
      <button type="button" id="dropdownToggle" onClick={handleClick} ref={dropdownToggleRef}
        className="px-5 py-2.5 rounded text-black text-sm font-semibold tracking-wide border-none outline-none bg-white">
        เลือกภาพยนตร์
      </button>
      ...
      <ul id="dropdownMenu" ref={dropdownMenuRef} className='absolute hidden shadow-lg bg-white py-2 px-2 z-[1000] min-w-full w-max rounded max-h-96 overflow-auto'>
        ...
        <li className='py-2.5 px-4 hover:bg-blue-50 text-black text-sm cursor-pointer rounded'>Dropdown option</li>
        <li className='py-2.5 px-4 hover:bg-blue-50 text-black text-sm cursor-pointer rounded'>Cloth set</li>
        <li className='py-2.5 px-4 hover:bg-blue-50 text-black text-sm cursor-pointer rounded'>Sales details</li>
        <li className='py-2.5 px-4 hover:bg-blue-50 text-black text-sm cursor-pointer rounded'>Marketing</li>
      </ul>
    </div>
