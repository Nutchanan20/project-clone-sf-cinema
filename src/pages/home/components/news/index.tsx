          ...
          <div className="px-[20px]">
            ...
            <div className="h-[225px] w-[255px] border border-[#989898]">
              <div className="p-[20px]">
                ...
                <input placeholder="อีเมล" className="rounded-sm w-[213.4px] h-[50px] px-2 focus:outline-none py[6px] text-[#555]"></input>
                <button className="bg-gradient-to-r from-[#2f66cd] to-[#5ab6de] flex justify-center items-center rounded-sm w-[213.4px] h-[50px] mt-[20px] text-white font-semibold">SUBSCRIBE</button>
              </div>
            </div>
            <div className="pt-[30px]">
              <img className="w-[255px] h-[255px]" src={PredatorPopcorn}></img>
            </div>
          </div>
        </div>
        <div>
          <div className="w-[1182px] h-[486.64px] grid grid-cols-3">
              {promotion2.map((news, index) => (
                <div className="w-[390px] h-[446.64px]">
                  <img className="w-[359.99px] h-[269.99px]" src={news.photo}></img>
